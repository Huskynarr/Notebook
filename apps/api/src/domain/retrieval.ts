...
const STOPWORDS = new Set([
  'aber','alle','als','also','am','an','auch','auf','aus','bei','bin','bis','da','dass','dem',
  'den','der','des','die','dies','diese','diesem','diesen','dieser','doch','dort','du','ein',
  'eine','einem','einen','einer','eines','er','es','fuer','für','hat','hatte','ich','ihr','im',
  'in','ist','ja','kann','man','mit','nach','nicht','noch','nun','nur','ob','oder','ohne','sich',
  'sie','sind','so','über','ueber','um','und','uns','vom','von','vor','war','was','wenn','wer',
  'wie','wir','wird','wo','zu','zum','zur','and','are','for','from','the','was','were','what',
  'when','which','with',
]);
