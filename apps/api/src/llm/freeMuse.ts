...
export const FREE_NEMOTRON_MODEL = 'nemotron-3.5-lightning-free';
...
export function isFreeNemotronConsole(base: string, model: string): boolean {
  return base.replace(/\/+$/, '') === OPENCODE_CONSOLE_URL && model === FREE_NEMOTRON_MODEL;
}
